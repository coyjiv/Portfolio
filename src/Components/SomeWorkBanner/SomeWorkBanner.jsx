...
const SomeWorkBanner = (props) => {
    const Cont = styled.section`padding-top:54px; padding-bottom: 35px; height:1077px; background-color:#2D2D2D; position: relative; z-index:0;`;
    ...
    useEffect(()=>{
        new hoverEffect({
            ...
            intensity: 0.1,
            image1: "/someworkbanner.png",
            image2: "/someworkbanner.png",
            displacementImage:
                "/DisplacementMap.png"
        });
    }, [container]);
