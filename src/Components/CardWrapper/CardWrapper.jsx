...
background: linear-gradient(0deg, rgba(168,168,168,1) 0%, rgba(196,196,196,1) 100%);box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.25);
                  "/>
            <Card url="https://fake-instagram-danit.herokuapp.com/" name="FAKE INSTA" infoSize="30" info="Fake Instagram Project it is an app that imitates Instagram functionallity"background="#201F1F" color="#C4C4C4" fsize="42"
                  addRules="
                  transform:translateY(26px)translateX(22px);
                  "
                  cardRules="background: rgb(94,97,97);
